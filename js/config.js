...
const Config = {
  ...
  */
  ...
  defaultItems: [
    ...
    { name: "Bow", type: "bow", baseQuality: 9, augments: [], variant: 1, value: 15, hubrisCost: 4, slots: [{type:"edge"},{type:"edge"},{type:"haft"}], zodiacTags: ["sagittarius", "gemini"] },
    ...
    { name: "Helm", type: "helm", baseQuality: 6, augments: [], variant: 0, value: 6, hubrisCost: 3, slots: [{type:"patina"},{type:"patina"},{type:"edge"}], zodiacTags: ["aries", "leo"] },
    ...
    { name: "Sandals", type: "sandals", baseQuality: 7, augments: [], variant: 1, value: 7, hubrisCost: 3, slots: [{type:"haft"},{type:"patina"},{type:"blessing"}], zodiacTags: ["gemini"] }
  ],
